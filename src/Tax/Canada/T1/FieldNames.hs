...
partAFields = Page5PartA {
   column1 = within "Column1" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount1"] $ Constant Amount 0,
       line69_overThreshold = Field ["Line38Amount1"] Amount,
       line70_rate = Field ["Line39Rate1"] $ Constant Percent 0.15,
       line71_timesRate = Field ["Line40Amount1"] Amount,
       line72_carry = Field ["Line41Amount1"] $ Constant Amount 0,
   ...
   column2 = within "Column2" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount2"] $ Constant Amount 50_197.00,
       line69_overThreshold = Field ["Line38Amount2"] Amount,
       line70_rate = Field ["Line39Rate2"] $ Constant Percent 0.205,
       line71_timesRate = Field ["Line40Amount2"] Amount,
       line72_carry = Field ["Line41Amount2"] $ Constant Amount 7_529.55,
   ...
   column3 = within "Column3" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount3"] $ Constant Amount 100_392.00,
       line69_overThreshold = Field ["Line38Amount3"] Amount,
       line70_rate = Field ["Line39Rate3"] $ Constant Percent 0.26,
       line71_timesRate = Field ["Line40Amount3"] Amount,
       line72_carry = Field ["Line41Amount3"] $ Constant Amount 17_819.53,
   ...
   column4 = within "Column4" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount4"] $ Constant Amount 155_625.00,
       line69_overThreshold = Field ["Line38Amount4"] Amount,
       line70_rate = Field ["Line39Rate4"] $ Constant Percent 0.29,
       line71_timesRate = Field ["Line40Amount4"] Amount,
       line72_carry = Field ["Line41Amount4"] $ Constant Amount 32_180.11,
   ...
   column5 = within "Column5" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount5"] $ Constant Amount 221_708.00,
       line69_overThreshold = Field ["Line38Amount5"] Amount,
       line70_rate = Field ["Line39Rate5"] $ Constant Percent 0.33,
       line71_timesRate = Field ["Line40Amount5"] Amount,
       line72_carry = Field ["Line41Amount5"] $ Constant Amount 51_344.18,
...
page6Fields = Page6 {
   ...
   line112 = Field ["Line31_Sub", "Line31_Rate"] $ Constant Percent 0.15,
