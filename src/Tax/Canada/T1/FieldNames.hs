...
page1IdentificationFields = Identification {
   ...
   your_Language = Field ["Your_Language", "RadioButtonlanguaget"] RadioButton,
...
page1SpouseFields = Spouse {
   ...
   sIN_Comb = Field ["SIN_Comb"] Textual}

page2Fields = Page2 {
   foreign_property = Field ["Line26600"] $ Switch "Option1" "Option2" "ForeignProperty_CheckBox",
...
page3Fields = Page3 {
   ...
   line_13000_OtherIncomeSource = Field ["Line_13000_Specify"] Textual,
...
page4Fields = Page4 {
   ...
   line_23200_Specify = Field ["Line_23200_Specify"] Textual,
...
page7Fields = Page7 {
   ...
   line40600 = Field ["Line40600_sub", "Line52Amount"] Amount,
