...
partAFields = Page5PartA {
   column1 = within "Column1" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount1"] $ Constant "0.00",
       line69_overThreshold = Field ["Line38Amount1"] Amount,
       line70_rate = Field ["Line39Rate1"] $ Constant "15%",
       line71_timesRate = Field ["Line40Amount1"] Amount,
       line72_carry = Field ["Line41Amount1"] $ Constant "0.00",
   ...
   column2 = within "Column2" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount2"] $ Constant "50,197.00",
       line69_overThreshold = Field ["Line38Amount2"] Amount,
       line70_rate = Field ["Line39Rate2"] $ Constant "20.5%",
       line71_timesRate = Field ["Line40Amount2"] Amount,
       line72_carry = Field ["Line41Amount2"] $ Constant "7,529.55",
   ...
   column3 = within "Column3" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount3"] $ Constant "100,392.00",
       line69_overThreshold = Field ["Line38Amount3"] Amount,
       line70_rate = Field ["Line39Rate3"] $ Constant "26%",
       line71_timesRate = Field ["Line40Amount3"] Amount,
       line72_carry = Field ["Line41Amount3"] $ Constant "17,819.53",
   ...
   column4 = within "Column4" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount4"] $ Constant "155,625.00",
       line69_overThreshold = Field ["Line38Amount4"] Amount,
       line70_rate = Field ["Line39Rate4"] $ Constant "29%",
       line71_timesRate = Field ["Line40Amount4"] Amount,
       line72_carry = Field ["Line41Amount4"] $ Constant "32,180.11",
   ...
   column5 = within "Column5" Rank2.<$> TaxIncomeBracket {
       ...
       line68_threshold = Field ["Line37Amount5"] $ Constant "221,708.00",
       line69_overThreshold = Field ["Line38Amount5"] Amount,
       line70_rate = Field ["Line39Rate5"] $ Constant "33%",
       line71_timesRate = Field ["Line40Amount5"] Amount,
       line72_carry = Field ["Line41Amount5"] $ Constant "51,344.18",
...
page6Fields = Page6 {
   ...
   line112 = Field ["Line31_Sub", "Line31_Rate"] $ Constant "15%",
