...
page1Fields = Page1 {
   ...
   line_63100_transit = Field ["Line63100", "Amount1"] Amount,
   line_63100_fraction = Field ["Line63100", "Amount2"] Amount,
   line16_sum = Field ["Line17", "Amount"] Amount}

page2Fields = Page2 {
   line17_copy = Field ["Line17", "Amount"] Amount,
   line_63105_renovation = Field ["Line63105", "Amount1"] Amount,
   line_63105_fraction = Field ["Line63105", "Amount2"] Amount,
