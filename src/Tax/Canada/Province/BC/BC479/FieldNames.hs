...
page2Fields = Page2 {
   ...
   line_60489_shares = Field ["BCVCTC", "Line18", "Amount"] Amount,
   line_60488_certificate = Field ["BCVCTC", "Line19", "Account_Number"] Textual,
   line20_sum = Field ["BCVCTC", "Line20", "I1", "Amount1"] Amount,
   line_60490_shares = Field ["BCVCTC", "Line21", "Amount"] Amount,
   line_60491_certificate = Field ["BCVCTC", "Line22", "Account_Number"] Textual,
   line_60495_shares = Field ["BCVCTC", "Line23", "Amount"] Amount,
   line_60496_certificate = Field ["BCVCTC", "Line24", "Account_Number"] Textual,
   line22_sum = subCalculationFields "BCVCTC" ["Line25", "I1", "Amount1"] ["Line25", "I2", "Amount2"],
   line_60510_fromT88 = Field ["BCMETC", "Line26", "Amount"] Amount,
   line_60530_fromT88 = Field ["BCMETC", "Line27", "Amount"] Amount,
   line_60545_buildings = Field ["BCCBTC", "Line28", "I1", "Amount1"] Amount,
   line_60546_partnership = Field ["BCCBTC", "Line29", "I1", "Amount1"] Amount,
   line27_sum = subCalculationFields "BCCBTC" ["Line30", "I1", "Amount1"] ["Line30", "I2", "Amount2"],
   line_60550_training = Field ["BCTTC", "Line31", "Amount"] Amount,
   line_60560_training = Field ["BCTTC", "Line32", "Amount"] Amount,
   line_60570_ships = Field ["BCTTC", "Line33", "Amount"] Amount,
   line31_sum = subCalculationFields "BCTTC" ["Line34", "I1", "Amount1"] ["Line34", "I2", "Amount2"],
   line32_credits = Field ["BCTTC", "Line35", "Amount"] Amount}

page3Fields :: Page3 FieldConst
page3Fields = Page3 {
   line33_copy = Field ["Line36", "Amount"] Amount,
   ...
   line_60575_sum = Field ["Line37", "Amount"] Count,
   line35_ceiling = Field ["Line38", "Amount_ReadOnly"] $ Constant 400 Amount,
   line36_income_copy = Field ["Line39", "Amount"] Amount,
   line37_threshold = Field ["Line40", "AmountRead_Only"] $ Constant 64_764 Amount,
   line38_difference = Field ["Line41", "Amount"] Amount,
   line39_rate = Field ["Line42", "PercentAmount_ReadOnly"] $ Constant 0.02 Percent,
   line40_fraction = subCalculationFields "Line43" ["L1", "Amount"] ["L2", "Amount2"],
   line_60576_difference = subCalculationFields "Line44" ["I1", "Amount1"] ["I2", "Amount2"],
   line42_credits = Field ["Line45", "Amount"] Amount}
