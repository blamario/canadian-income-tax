...
page1Fields = Page1 {
   ...
   line3_sum_spouse = Field ["Chart", "Column1", "Line3", "Col2_Amount"] Amount,
   ...
   line_60480_renovation = Field ["Line14", "Line60480", "Amount"] Amount,
   line14_fraction = Field ["Line14", "Amount"] Amount,
   line15_sum = Field ["Line15", "Amount"] Amount}

page2Fields = Page2 {
   line16_copy = Field ["Line16", "Amount"] Amount,
   line17_venture = Field ["Line17", "Amount"] Amount,
   ...
   line22_sum = Field ["Line22", "I1", "Amount1"] Amount,
   line22_cont = Field ["Line22", "I2", "Amount"] Amount,
   ...
   line29_credits = Field ["Line29", "Amount"] Amount}
