...
deriving instance (Show (T1 line), Show (ON428 line), Show (ON479 line)) => Show (Returns line)
deriving instance (Eq (T1 line), Eq (ON428 line), Eq (ON479 line)) => Eq (Returns line)
